    ...
    <div  name='trainings' className='w-full py-[5rem] px-4 bg-white'>
      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 mt-20'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <a className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-center' target="_blank" href="https://www.lyceesaintnicolas.com/">Learn more</a>
          </div>
          <div className='w-full shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
              ...
              <a className='bg-black w-[200px] text-white rounded-md font-medium my-6 mx-auto px-6 py-3 text-center' target="_blank" href="https://www.lyceedecachan.fr/">Learn more</a>
          </div>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              <div className='w-50 mx-auto mt-[-3rem] bg-white'><FaSchool size={70}/></div>
              ...
              <a className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-center' target="_blank" href="https://www.esilv.fr/formations/cycle-ingenieur/majeures/fintech/">Learn more</a>
          </div>
      </div>
    </div>
  );
